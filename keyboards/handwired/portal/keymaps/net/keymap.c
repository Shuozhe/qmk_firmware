...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LA(KC_GRV),  KC_1, KC_2, KC_3, KC_4,    KC_5,                               PAREN,   KC_6,    KC_7,    KC_8,     KC_9,     KC_0,     KC_GRV, \
        KC_TAB,  KC_Q, KC_W, KC_E, KC_R,    KC_T,                               KC_LGUI, KC_Y,    KC_U,    KC_I,     KC_O,     KC_P,     KC_MINS, \
        KC_LSFT, KC_A, KC_S, KC_D, KC_F,    KC_G,                               RANDOM,  KC_H,    KC_J,    KC_K,     KC_L,     KC_SCLN,  KC_QUOT, \
        KC_ESC,  KC_Z, KC_X, KC_C, KC_V,    KC_B,    LT(1, KC_ENT),    KC_BSPC, CCCV,    KC_N,    KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,  RSFT_T(KC_CAPS), \
                                   KC_LCTL, KC_LALT, LGUI_T(KC_SPC),   KC_SPC,  TT(3),   KC_BSPC,                    KC_LEFT,  KC_RIGHT, KC_DOWN),
