...
#define _QWERTY 0
#define _RAISE 1
#define _CALCULATOR 2

#define _COLEMAK 5
#define _DVORAK_SHIFT 6
...
\
                 ...
                 KC_LGUI,   KC_Y,    KC_U,   KC_I,    KC_O,    KC_P,     KC_MINS,          \
                 RANDOM,    KC_H,    KC_J,   KC_K,    KC_L,    KC_LBRC,  KC_RBRC,          \
      KC_SCLN,   KC_QUOT,   KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH,  RSFT_T(KC_CAPS), \
      KC_BSPC,   TT(3),     KC_BSPC,                  KC_LEFT, KC_RIGHT, KC_DOWN),
    ...
    [_RAISE] = LAYOUT(
      ...
      KC_INS, KC_HOME, KC_UP, KC_END, _______, KC_PGUP, \
        ...
        _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, _______, KC_TRNS, \
                                            KC_LGUI, _______, KC_TRNS, \
\
          KC_F6, KC_F7, KC_F8,   KC_F9,   KC_F10,  KC_F11, KC_F12, \
          KC_2,  KC_Y,  KC_U,    KC_I,    KC_O,    KC_P,    KC_MINS, \
          KC_3,  KC_H,  KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
      KC_BSPC, KC_N,  KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT, \
      KC_SPC, KC_TRNS, KC_BSPC, KC_DOWN, KC_LEFT, KC_RIGHT, KC_UP),
...
\
              ...
              RANDOM,  KC_H,    KC_N,    KC_E,     KC_I,     KC_O,     KC_QUOT, \
